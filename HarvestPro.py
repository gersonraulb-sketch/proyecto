...
if tipo == "azucar" and cantidad <= 5 and temporada == "lluvia":
    print("""
          ...
          """)
elif tipo == "azucar" and cantidad >= 6 and temporada == "lluvia":
    print("""
          ...
          """)
elif tipo == "azucar" and cantidad <= 5 and temporada == "seca":
    print("""
          ...
          """)
elif tipo == "azucar" and cantidad >= 6 and temporada == "seca":
    print("""
...
elif tipo == "cafe" and cantidad <= 5 and temporada == "lluvia":
    print("""
          ...
          """)
elif tipo == "cafe" and cantidad >= 6 and temporada == "lluvia":
    print("""
          ...
          """)    
elif tipo == "cafe" and cantidad <= 5 and temporada == "seca":
    print("""
         ...
         """)
elif tipo == "cafe" and cantidad >= 6 and temporada == "seca":
    print("""
